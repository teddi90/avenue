<template>
    <MainLayout>
        <section class="product" v-if="product && product.data">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <div class="product__slider">
                            <div class="product__slider-aside">
                                <div
                                    class="product__slider-thumbnail"
                                    :class="{
                                        thumbnail__current:
                                            currentImage === image,
                                    }"
                    ...
                    <div class="col-md-4">
                        <h2 class="product__title">{{ product.data.title }}</h2>
                        <p class="product__price">
                            ${{ product.data.price / 100 }}
                        </p>
                        <div class="product__sizes">
                            <h4 class="product__subtitle">Розміри</h4>
                            <div
                                v-for="size in sizes"
                                :key="size"
                                class="product__size"
                        ...
                        <button
                            ...
                            class="btn"
                        >
                            <span v-if="isInCart">Товар додано</span>
                            <span v-else>Додати у кошик</span>
